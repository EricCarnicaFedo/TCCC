...
<header id="navbar">
  ...
  <nav class="">
    ...
    <ul class="navbarconteudo">
      ...
      <a href="login.html" class="tel-link">cadastrar-se</a>
  </nav>
...
<div id="sidebar" class="sidebar">
  ...
  <a href="historico.html"><i class='bx bxs-time'></i> <span class="sidebar-text">Historico</span></a>
  <a href="cadastroteste.html"><i class='bx bxs-file-plus'></i> <span class="sidebar-text">Cadastros</span></a>
...
<body>
  ...
  <section id="services-section" class="custom-services-section">
    <div class="custom-container">
      ...
      <h2 class="botarfonte">Funcionalidades</h2>
      
      <img
            src="https://i.postimg.cc/5NTNy7Qf/cortcc.png"
            alt="Serviço 1" style=" width: 300px;  transform: translateX(800px); margin-top: -200px; z-index: -10; 
              position: absolute;
      ...
      <div class="custom-services-list">
        ...
        <div class="custom-service">
          <img
    src="https://i.postimg.cc/L57vmpcw/ddsdararra.png"
    alt="Serviço 4"
    ...
    height="300">
          ...
          <h3>Pets</h3>
          <p>Gerencie todas as informações dos pets com eficiência: mantenha registros completos, incluindo raça, idade
            e histórico médico. Acesse rapidamente o histórico de saúde de cada pet para um atendimento mais eficiente e
            personalizado. Armazene fotos e documentos importantes, como resultados de exames e prescrições médicas,
            garantindo uma gestão organizada e detalhada.
          </p>
        </div>
      </div>
    </div>
  ...
  <section id="blog-section" class="custom-blog-section">
    <div class="custom-container">
      <h2>Funcionalidades em Ação</h2>
      <div class="custom-blog-posts">
        <div class="custom-blog-post">
          <img src="https://via.placeholder.com/300" alt="Artigo 1">
          <h3>Título do Artigo 1</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nec odio.</p>
          <a href="#">Leia mais</a>
        </div>
        <div class="custom-blog-post">
          <img src="https://via.placeholder.com/300" alt="Artigo 2">
          <h3>Título do Artigo 2</h3>
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse potenti.</p>
          <a href="#">Leia mais</a>
        </div>
        <div class="custom-blog-post">
          <img src="https://via.placeholder.com/300" alt="Artigo 3">
          <h3>Título do Artigo 3</h3>
          <p>Nullam laoreet quam vel fringilla vestibulum. Morbi rutrum mi quis arcu.</p>
          <a href="#">Leia mais</a>
        </div>
      </div>
    </div>
